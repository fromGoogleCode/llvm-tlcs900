...
#ifndef LLVM_TARGET_TLCS900_ISELLOWERING_H
#define LLVM_TARGET_TLCS900_ISELLOWERING_H
...
namespace llvm {
  namespace TLCS900ISD {
    enum {
      ...
      /// TLCS900 conditional branches. Operand 0 is the chain operand, operand 1
  ...
  public:
    explicit TLCS900TargetLowering(TLCS900TargetMachine &TM);
  ...
  private:
    ...
    const TLCS900TargetMachine &TM;
    const TargetData *TD;
  };
} // namespace llvm

#endif // LLVM_TARGET_TLCS900_ISELLOWERING_H
